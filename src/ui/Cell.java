...
public class Cell extends JComponent {
    ...
    public Cell(int id) {
        ...
        if (imageDictionary == null) {
            ...
            imageDictionary.put(STATE_NOT_INFECTED, ImageHelper.fromResource("resources/smiling.png"));
            imageDictionary.put(STATE_IMMUNE, ImageHelper.fromResource("resources/sunglasses.png"));
            imageDictionary.put(STATE_INFECTED, ImageHelper.fromResource("resources/infected.png"));
            imageDictionary.put(STATE_SURROUNDED, ImageHelper.fromResource("resources/surrounded.png"));
            imageDictionary.put(STATE_MASKED, ImageHelper.fromResource("resources/masked.png"));
            imageDictionary.put(STATE_DEAD, ImageHelper.fromResource("resources/dead.png"));
            ...
            colorDictionary.put(STATE_SURROUNDED, Color.decode("#008000"));
